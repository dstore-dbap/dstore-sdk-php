...
/**
 * Protobuf type <code>dstore.engine.om_GetCampaignBonusItems_Pu.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Om_GetCampaignBonusItems_Pu\Response_Row::class);
        $this->row = $var;
    }
