...
/**
 * Protobuf type <code>dstore.engine.mi_GetLocales.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Mi_GetLocales\Response_Row::class);
        $this->row = $var;
    }
