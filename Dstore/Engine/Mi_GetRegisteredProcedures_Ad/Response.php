...
/**
 * Protobuf type <code>dstore.engine.mi_GetRegisteredProcedures_Ad.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Mi_GetRegisteredProcedures_Ad\Response_Row::class);
        $this->row = $var;
    }
