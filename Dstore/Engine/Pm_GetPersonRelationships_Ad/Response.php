...
/**
 * Protobuf type <code>dstore.engine.pm_GetPersonRelationships_Ad.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Pm_GetPersonRelationships_Ad\Response_Row::class);
        $this->row = $var;
    }
