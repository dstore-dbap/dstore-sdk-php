...
/**
 * Protobuf type <code>dstore.engine.im_SynchronizeItemBinaries_Ad.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Im_SynchronizeItemBinaries_Ad\Response_Row::class);
        $this->row = $var;
    }
