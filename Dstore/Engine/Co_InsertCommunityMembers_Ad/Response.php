...
/**
 * Protobuf type <code>dstore.engine.co_InsertCommunityMembers_Ad.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Co_InsertCommunityMembers_Ad\Response_Row::class);
        $this->row = $var;
    }
