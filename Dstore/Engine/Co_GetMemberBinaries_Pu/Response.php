...
/**
 * Protobuf type <code>dstore.engine.co_GetMemberBinaries_Pu.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Co_GetMemberBinaries_Pu\Response_Row::class);
        $this->row = $var;
    }
