...
/**
 * Protobuf type <code>dstore.engine.im_GetSimpleProductInfo_Pu.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Im_GetSimpleProductInfo_Pu\Response_Row::class);
        $this->row = $var;
    }
