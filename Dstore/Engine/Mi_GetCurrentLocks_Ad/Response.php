...
/**
 * Protobuf type <code>dstore.engine.mi_GetCurrentLocks_Ad.Response</code>
 */
class Response extends \Google\Protobuf\Internal\Message
{
    ...
    {
        GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Dstore\Engine\Mi_GetCurrentLocks_Ad\Response_Row::class);
        $this->row = $var;
    }
