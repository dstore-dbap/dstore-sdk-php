...
namespace dstore\engine\im_InsertNodeBinary_Ad\Response {
  ...
  class Row extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.im_InsertNodeBinary_Ad.Response.Row');
