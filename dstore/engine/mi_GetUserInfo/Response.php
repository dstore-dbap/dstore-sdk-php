...
namespace dstore\engine\mi_GetUserInfo {
  ...
  class Response extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \dstore\engine\mi_GetUserInfo\Response\Row[]  */
    public $row = array();
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.mi_GetUserInfo.Response');
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_REPEATED;
      $f->reference = '\dstore\engine\mi_GetUserInfo\Response\Row';
      $descriptor->addField($f);

      // OPTIONAL MESSAGE user_id = 101
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 101;
      $f->name      = "user_id";
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
     ...
     * Clear <error> value
     *
     * @return \dstore\engine\mi_GetUserInfo\Response
     */
     ...
     * Set <row> value
     *
     * @param \dstore\engine\mi_GetUserInfo\Response\Row $value
     * @return \dstore\engine\mi_GetUserInfo\Response
     */
    public function setRow(\dstore\engine\mi_GetUserInfo\Response\Row $value, $idx = NULL){
     ...
     * @return \dstore\engine\mi_GetUserInfo\Response
     */
    public function addRow(\dstore\engine\mi_GetUserInfo\Response\Row $value){
