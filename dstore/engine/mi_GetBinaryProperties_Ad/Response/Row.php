...
namespace dstore\engine\mi_GetBinaryProperties_Ad\Response {
  ...
  class Row extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.mi_GetBinaryProperties_Ad.Response.Row');
