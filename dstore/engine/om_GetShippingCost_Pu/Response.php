...
namespace dstore\engine\om_GetShippingCost_Pu {
  ...
  class Response extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \dstore\engine\om_GetShippingCost_Pu\Response\Row[]  */
    public $row = array();
    ...
    /**  @var \dstore\values\decimalValue */
    public $shipping_cost_brutto = null;
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.om_GetShippingCost_Pu.Response');
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_REPEATED;
      $f->reference = '\dstore\engine\om_GetShippingCost_Pu\Response\Row';
      $descriptor->addField($f);

      // OPTIONAL MESSAGE shipping_cost = 101
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 101;
      ...
      // OPTIONAL MESSAGE shipping_cost_brutto = 102
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 102;
      $f->name      = "shipping_cost_brutto";
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_OPTIONAL;
      $f->reference = '\dstore\values\decimalValue';
      $descriptor->addField($f);
     ...
     * Clear <error> value
     *
     * @return \dstore\engine\om_GetShippingCost_Pu\Response
     */
     ...
     *
     * @param int $idx
     * @return \dstore\engine\om_GetShippingCost_Pu\Response\Row
     */
     ...
     * Set <row> value
     *
     * @param \dstore\engine\om_GetShippingCost_Pu\Response\Row $value
     * @return \dstore\engine\om_GetShippingCost_Pu\Response
     */
    public function setRow(\dstore\engine\om_GetShippingCost_Pu\Response\Row $value, $idx = NULL){
     ...
     * @return \dstore\engine\om_GetShippingCost_Pu\Response
     */
    public function addRow(\dstore\engine\om_GetShippingCost_Pu\Response\Row $value){
    ...
    /**
     * Check if <shipping_cost_brutto> has a value
     *
     * @return boolean
     */
    public function hasShippingCostBrutto(){
      return $this->_has(102);
    }
    
    /**
     * Clear <shipping_cost_brutto> value
     *
     * @return \dstore\engine\om_GetShippingCost_Pu\Response
     */
    public function clearShippingCostBrutto(){
      return $this->_clear(102);
    }
    
    /**
     * Get <shipping_cost_brutto> value
     *
     * @return \dstore\values\decimalValue
     */
    ...
    /**
     * Set <shipping_cost_brutto> value
     *
     * @param \dstore\values\decimalValue $value
     * @return \dstore\engine\om_GetShippingCost_Pu\Response
     */
    public function setShippingCostBrutto(\dstore\values\decimalValue $value){
