...
namespace dstore\engine\ac_InsertActionLog_Ad\Response {
  ...
  class Row extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.ac_InsertActionLog_Ad.Response.Row');
