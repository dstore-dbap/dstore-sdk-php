...
namespace dstore\engine\om_GetTaxes {
  ...
  class Response extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \dstore\engine\om_GetTaxes\Response\Row[]  */
    public $row = array();
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.om_GetTaxes.Response');
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_REPEATED;
      $f->reference = '\dstore\engine\om_GetTaxes\Response\Row';
      $descriptor->addField($f);
     ...
     * Clear <error> value
     *
     * @return \dstore\engine\om_GetTaxes\Response
     */
     ...
     * Set <row> value
     *
     * @param \dstore\engine\om_GetTaxes\Response\Row $value
     * @return \dstore\engine\om_GetTaxes\Response
     */
    public function setRow(\dstore\engine\om_GetTaxes\Response\Row $value, $idx = NULL){
     ...
     * @return \dstore\engine\om_GetTaxes\Response
     */
    public function addRow(\dstore\engine\om_GetTaxes\Response\Row $value){
