...
namespace dstore\engine\st_GetTreeNodePDStatistics_Ad {
  ...
  class Parameters extends \DrSlump\Protobuf\Message {
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.st_GetTreeNodePDStatistics_Ad.Parameters');
      ...
      // OPTIONAL MESSAGE h_tree_node_ids = 4
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 4;
      ...
      // OPTIONAL MESSAGE summarize_days = 5
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 5;
     ...
     *
     * @return \dstore\engine\st_GetTreeNodePDStatistics_Ad\Parameters
     */
