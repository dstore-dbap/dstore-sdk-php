...
namespace dstore\engine\co_GetCommunityForums_Pu {
  ...
  class Response extends \DrSlump\Protobuf\Message {
    ...
    /**  @var \dstore\engine\co_GetCommunityForums_Pu\Response\Row[]  */
    public $row = array();
    ...
    {
      $descriptor = new \DrSlump\Protobuf\Descriptor(__CLASS__, 'dstore.engine.co_GetCommunityForums_Pu.Response');
      ...
      $f->type      = \DrSlump\Protobuf::TYPE_MESSAGE;
      $f->rule      = \DrSlump\Protobuf::RULE_REPEATED;
      $f->reference = '\dstore\engine\co_GetCommunityForums_Pu\Response\Row';
      $descriptor->addField($f);

      // OPTIONAL MESSAGE community_member_id = 101
      $f = new \DrSlump\Protobuf\Field();
      $f->number    = 101;
     ...
     * Clear <error> value
     *
     * @return \dstore\engine\co_GetCommunityForums_Pu\Response
     */
     ...
     * Set <row> value
     *
     * @param \dstore\engine\co_GetCommunityForums_Pu\Response\Row $value
     * @return \dstore\engine\co_GetCommunityForums_Pu\Response
     */
    public function setRow(\dstore\engine\co_GetCommunityForums_Pu\Response\Row $value, $idx = NULL){
     ...
     * @return \dstore\engine\co_GetCommunityForums_Pu\Response
     */
    public function addRow(\dstore\engine\co_GetCommunityForums_Pu\Response\Row $value){
